  ...
  <section class="two">
    <div class="container">
      <div class="left">
        ...
        <p>
          Securely access your account or create a new one using the appropriate
          link
        </p>
      </div>
      <div class="right">
  ...
  <section class="three">
    ...
    <div class="container">
      ...
      <div class="item">
        ...
        <p>
          Use our free guide to help see which advice option may be best for
      ...
      <div class="item">
        ...
        <p>
          Ready to plan your financial future? We have what you need to be a
    ...
    <div class="container">
      <div class="left">
        ...
        <p>
          ...
          first. Your goals are always our goals.
        </p>
          ...
          <h3
            ...
            @click="
              (debt = true),
                ...
                (plan = false),
                (retire = false),
                (videoText = 'I am taking control of my debt, and my life')
            "
          >
            Manage debt
          </h3>
          ...
          <h3
            ...
            @click="
              (debt = false),
                ...
                (retire = false),
                (videoText =
                  'Planning helps me save—for the big and little things.')
            "
          >
            Save more
          </h3>
          ...
          <h3
            ...
            @click="
              (debt = false),
                ...
                (retire = false),
                (videoText =
                  'We want to give our grandchildren the gift of financial security.')
            "
          >
            Plan your legacy
          </h3>
          ...
          <h3
            ...
            @click="
              (debt = false),
                ...
                (plan = false),
                (retire = true),
                (videoText = 'My future is worth planning for.')
            "
          >
            Retire
          </h3>
