  ...
  <main>
    ...
    <section class="protect">
      <div>
        ...
        <p>
          Investors come first in everything we do, including our security
          features. Learn how we protect you and what you can do to keep your
          accounts safe.
        </p>
        <h1>Website security</h1>
        <p>
          Our website employs various security features—visible and invisible—to
          help keep you safe.
        </p>
        <ul>
          <li>Encryption</li>
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            account information (e.g., username, password, or Social Security
            number).
          </li>
          <li>
        ...
        <h1>Disclaimer</h1>
        <p>
          We'll never call you and ask for your password or logon credentials,
          your Social Security number, or a security code you've received via
          text or automated call. You should never disclose this information to
          anyone over the phone. If you suspect someone has gained access to
          this information, contact our fraud team immediately.
        </p>
      </div>
    </section>
  </main>
